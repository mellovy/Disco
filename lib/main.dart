      ...
      builder: (context, mode, _) {
        return MaterialApp(
          ...
          theme: ThemeData(
            ...
            scaffoldBackgroundColor: const Color(0xFFF1E6FF),
...
class _DiscoAppState extends State<DiscoApp> {
  List<Color> discoColors = [
    const Color(0x78AE65EC),
    const Color(0x78EB6276),
    const Color(0x78FFB7E4),
    const Color(0x78FF66C4),
  ];
  int colorIndex = 0;
  Timer? timer;
      ...
      body: AnimatedContainer(
        ...
        child: Center(
          child: SingleChildScrollView(
            child: Column(
              children: [
                Image.asset('images/disco1.png',
                    width: 200,
                    height: 200,
                    errorBuilder: (c, e, s) =>
                        const Icon(Icons.music_note, size: 100)),
                const Text('Feel the Groove',
                    style: TextStyle(
                        fontSize: 22,
                        color: Colors.white,
